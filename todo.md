...
* look into making footer hang at bottom of an article if it is longer than the page. like to hide rather than always be fixed at bottom of vp.
* find best practices for how to style nav text. should I be using header tags?
